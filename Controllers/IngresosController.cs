...
namespace crudNomina.Controllers
{
    public class IngresosController : Controller
    {
        ...
        public IngresosController(NominaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,DependeSalario,Monto,Estado")] Ingreso ingreso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,DependeSalario,Monto,Estado")] Ingreso ingreso)
        {
            if (id != ingreso.Id)
            {
                return NotFound();
